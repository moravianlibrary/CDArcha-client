...
namespace CDArcha_klient
{
    ...
    public static class Settings
    {
        ...
        internal static string TmpDir
        {
            ...
            set
            {
                SetRegistryValue(IsAdminTmpDir, "TmpDir", value, RegistryValueKind.String);
            }
        }
        ...
        /// <summary>Indicates that scan tmp directory was filled by admin and can't be changed in application</summary>
        internal static bool IsAdminTmpDir
        {
            get
            {
                return AdminSettingsRegistryKey != null && AdminSettingsRegistryKey.GetValue("TmpDir", null) != null;
            }
        }
        ...
        // <summary>Default cesta pro ukladani docasniho souboru</summary>
        internal static string tmpPathToIso = System.IO.Path.Combine(TmpDir, "working.iso");
