...
namespace CDArcha_klient
{
    ...
    public static class OldSettings
    {
        ...
        private static string SettingsFile
        {
            get
            {
                return Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)
                    + @"\CDArcha_klient\settings.config";
            }
        }
        ...
        internal const string UpdateServer = "http://10.89.56.103/obalkyknih-scanner";

        /// <summary>URL of import function on obalkyknih.</summary>
        //internal const string ImportLink = "http://www.obalkyknih.cz/api/import";
        internal const string ImportLink = "http://10.89.56.103/api/import";

        /// <summary>
        /// Returns path to temporary folder, where are stored images opened in external editor
        /// and downloaded updates
        /// </summary>
        internal static string TemporaryFolder { get { return System.IO.Path.GetTempPath() + "CDArcha_klient\\"; } }
