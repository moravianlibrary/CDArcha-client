...
Source: "..\CDArcha_klient\bin\Release\DiscUtils.Core.dll"; DestDir: "{app}"
Source: "..\CDArcha_klient\bin\Release\DiscUtils.Iso9660.dll"; DestDir: "{app}"
Source: "..\CDArcha_klient\bin\Release\DiscUtils.Udf.dll"; DestDir: "{app}"
Source: "..\CDArcha_klient\bin\Release\DiscUtils.Streams.dll"; DestDir: "{app}"
